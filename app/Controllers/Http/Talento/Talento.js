...
class Talento {
    ...
    async addCurriculumPersona({request,response}){
        ...
        const cliente = request.input('cliente');
        console.log("titulo= " + titulo + " bajada= " + bajada + " desde= " + desde + " hasta= " + hasta + " descripcion= " + descripcion + " idPersona= " + idPersona + " idPersonaCurriculumCategoria= " + idPersonaCurriculumCategoria)
